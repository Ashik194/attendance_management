                    ...
                    <div class="card-body p-4">
                        ...
                        <form action="{{route('login')}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('email') is-invalid @enderror" type="email" id="login" name="email" :value="old('email')" required autofocus autocomplete="username" placeholder="Enter your email">
                                @error('email')
